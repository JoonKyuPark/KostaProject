	$(function() {
		...
		function work_year_up(){
			...
			//career_year1 += $('.resume_career_join_date_input').html().substring(8,11);//13
			...
			//career_year2 += $('.resume_career_join_date_input').html().substring(21,24);//13
		...
		$(function(){
			...
			$('#career_add_btn').on('click', career_add_btn_fn)
