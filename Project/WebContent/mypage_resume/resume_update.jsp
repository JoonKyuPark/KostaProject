...
<body>
	<div id="container" class="col-md-12">
		...
		<div class="content col-md-8">
			<form class="resume_form form-horizontal col-md-12" action="resume_update_action.jsp" method="post">
				<div class="form-group col-md-12">
				
				<!-- id확인 -->
				<input type="hidden" value="${re.resume_no}" name="resume_no">
				<input type="hidden" value="${re.ac_ability_no}" name="ac_ability_no">
				<input type="hidden" value="${re.career_no}" name="career_no">				
				
				
					<br> <br> <br> <br> <br> <br> <label for="resume_title_input" class="glyphicon glyphicon-pencil col-md-2 control-label">제목</label>
					<div class="col-md-10">
						<input type="text" class="form-control" id="resume_title_input" placeholder="제목을 입력해주세요" name="resume_title" value="${re.resume_title}">
					</div>
					<br> <br> <br> 
					<label for="resume_income_input" class="col-md-2 control-label">희망연봉</label>
					<div class="col-md-10">
						<input type="text" class="form-control" id="resume_income_input" placeholder="희망연봉" name="hope_income" value="${re.hope_income}">
					</div>
					<br> <br> <br>
					...
					<div id="career_wrapper">
						<div id="career" class="form-inline career">
							...
							<div class="resume_career_etp_name_div col-md-4">
								<input type="text" id="resume_career_etp_name_input" class="form-control" name="career_etp_name" value="${re.career_etp_name}">
							</div>
							...
							<div id="reportrange" class="col-md-4 form-inline reportrange" style="background: #fff; cursor: pointer; padding-top: 5px" onclick="cb()">
								<i class="glyphicon glyphicon-calendar fa fa-calendar"></i> <span class="resume_career_join_date_input">${re.join_date}~${re.retire_date}</span> <b class="caret"></b>
							...
							<div class="col-md-4">
								<input type="hidden" class="resume_carrer_work_year" name="work_year" value="${re.work_year}">
							...
							<div class="resume_career_field_div col-md-4">
								<input type="text" id="resume_career_field_input" class="form-control" name="career_field" value="${re.career_field}">
							</div>
							<label for="resume_work_dept_input" class="col-md-2 control-label">근무부서</label>
							<div class="resume_work_dept_div col-md-4">
								<input type="text" id="resume_work_dept_input" class="form-control" name="work_dept" value="${re.work_dept}">
							</div>
							
							
							<br> <br> <label for="resume_work_rank_input" class="col-md-2 control-label">직급</label>
							<div class="resume_work_rank_div col-md-4">
								<input type="text" id="resume_work_rank_input" class="form-control" name="work_rank" value="${re.work_rank}">
							</div>
							...
							<div class="resume_responibility_field_div col-md-4">
								<input type="text" id="resume_responibility_field_input" class="form-control" name="important_ability" value="${re.important_ability}">
							</div>
							...
							<div class="resume_retire_reasion_div col-md-4">
								<input type="text" id="resume_retire_reasion_input" class="form-control" name="retire_reasion" value="${re.retire_reasion}">
							</div>
							<label for="resume_work_location_input" class="col-md-2 control-label">근무지역</label>
							<div class="resume_work_location_div col-md-4">
								<input type="text" id="resume_work_location_input" class="form-control" name="work_location" value="${re.work_location}">
							</div>
							...
							<div class="resume_work_income_div col-md-10">
								<input type="text" id="resume_work_income_input" class="form-control" name="work_income" value="${re.work_income}"> &nbsp;만원
							</div>
							
							<label for="resume_responibility_field_input" class="col-md-2 control-label">경력업무</label>
							<div class="resume_responibility_field_div col-md-4">
								<input type="text" id="resume_responibility_field_input" class="form-control" name="responibility_field" value="${re.responibility_field}"> 
							</div>
						...
						<label for="resume_career_year_input" class="col-md-2 control-label">총 경력</label>
							<div class="resume_career_year_div col-md-4">
								<input type="hidden" id="resume_career_year_input" name="career_year" value="${re.career_year}">
					...
					<div class="form-inline">  <!-- 학력사항~~~ -->
						...
						<div class="resume_school_name_div col-md-4">
							<input type="text" value="2014-10" class="monthpicker form-control" name="enter_date" value="${re.enter_date}">
						</div>
						<label for="monthpicker" class="col-md-2 control-label">졸업연월</label>
						<div class="resume_school_name_div col-md-4">
							<input type="text" value="2014-10" class="monthpicker form-control col-md-4" name="graduation_date" value="${re.graduation_date}">
						</div>
					</div>
					<br> <br>
					...
					<div class="form-horizontal">
						...
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_school_name_input" class="form-control col-md-12" name="school_name" value="${re.school_name}">
						</div>


						<label for="resume_major" class="col-md-2 control-label">학점</label>
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_b_input" class="form-control" name="grade" value="${re.grade}">
						</div>
					</div>
					<br> <br>
					<div class="form-horizontal">
						...
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_1_input" class="form-control" name="major_1" value="${re.major_1}">
						</div>
						<label for="resume_major" class="col-md-2 control-label">전공2</label>
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_2_input" class="form-control" name="major_2" value="${re.major_2}">
						</div>
					</div>
					<br> <br>
				...
				<input type="submit" value="변경" class="btn btn-primary col-md-offset-4 col-md-2"> <input type="reset" value="취소"
