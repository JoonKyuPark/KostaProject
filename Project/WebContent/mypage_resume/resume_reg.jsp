...
<body>
	<div id="container" class="col-md-12">
		...
		<div class="content col-md-8">
			<form class="resume_form form-horizontal col-md-12">
				<div class="form-group col-md-12">
					<br> <br> <br>
					<br> <br> <br> <label for="resume_title_input"
						class="col-md-2 control-label">제목</label>
					<div class="col-md-10">
						<input type="text" class="form-control" id="resume_title_input"
							placeholder="제목을 입력해주세요" name="resume_title" required>
					</div>
					...
					<div class="col-md-10">
						<input type="text" class="form-control" id="resume_income_input"
							placeholder="희망연봉" name="hope_income">
					</div>
					<br> <br> <br>
					...
					<div class="resume_volun_field_form col-md-10">
						<input type="checkbox" value="정규직" name="volun_field">정규직&nbsp;
						<input type="checkbox" value="계약직" name="volun_field">계약직&nbsp;
						<input type="checkbox" value="병역특례" name="volun_field">병역특례&nbsp;
						<input type="checkbox" value="인턴직" name="volun_field">인턴직&nbsp;
						<input type="checkbox" value="프리랜서" name="volun_field">프리랜서&nbsp;

					</div>
					<!-- ~~~resume_volun_field_form 지원분야 체크박스 -->
					<br> <br> <br> <label for="resume_hope_income_input"
						class="col-md-2 control-label">희망연봉</label>
					<div class="resume_hope_income_div col-md-10 form-inline">
						<input type="text" id="resume_work_income_input"
							class="form-control"> &nbsp;만원
					</div>
					...
					<div id="career" class="form-inline">
						...
						<label for="resume_carrer_work_state_label"
							class="col-md-2 control-label">재직여부</label> <select
							name="resume_carrer_work_state" class="form-control col-md-4">
							<option value="N">퇴사</option>
							<option value="Y">재직</option>
						</select> <br> <br> <br> <label for="reportrange"
							class="resume_career_join_date_label col-md-2 control-label">입사·퇴사일</label>
						<div id="reportrange" class="col-md-4 form-inline"
							style="background: #fff; cursor: pointer; padding-top: 5px">
							<i class="glyphicon glyphicon-calendar fa fa-calendar"></i> <span
								class="resume_career_join_date_input"></span> <b class="caret"></b>
						</div>

						<label for="reportrange"
							class="resume_career_join_date_label col-md-2 control-label">경력기간</label>
						<div class="col-md-4">
						...
						<br>
						<br> <label for="resume_work_rank_input"
						...
						<br>
						<br> <label for="resume_retire_reasion_input"
						...
						<br>
						<br> <label for="resume_work_income_input"
						...
						<button id="career_add_btn btn btn-success">경력 추가</button>
					...
					<div class="form-horizontal">
						...
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_b_input" class="form-control">
						</div>
					</div>
					<br>
					<br>
					<div class="form-horizontal">
						...
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_1_input" class="form-control">
						</div>
						<label for="resume_major" class="col-md-2 control-label">전공2</label>
						<div class="resume_school_name_div col-md-4">
							<input type="text" id="resume_major_2_input" class="form-control">
						</div>
					</div>
					<br>
					<br>
					...
					<div class="form-horizontal col-md-12">
						...
						<textarea class="form-control col-md-12"
							id="resume_self_intro_cont" rows="5" required></textarea>
					</div>
				</div>
				<!-- form-group -->
