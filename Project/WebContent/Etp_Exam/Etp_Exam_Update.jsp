			...
			<div class="inputExamForm col-md-8">
				<form role="form" action="Etp_Exam_UpdateOk.jsp" method="post">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-12">
							<input type="text" class="form-control col-md-12" name = "exam_name" value = "<%=selectExam.getExam_name()%>">
						</div>
						<br>
						<br>
						<br>
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-12">
							<input type="number" class="examNumberForm form-control col-md-3" name="exam_number" style = "padding-right : 0;" value="<%=selectExam.getExam_number()%>">
