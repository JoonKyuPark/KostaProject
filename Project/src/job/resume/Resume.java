...
public class Resume {
	...
	public Resume(int resume_no, String resume_title, int hope_income, String volun_field, String resume_date, String career_no, int ac_ability_no, String self_intro_cont, String self_intro_date,
