...
public class Recruit_Infor {
	...
	private int etp_no;  //기업회원번호 
	
	public Recruit_Infor(){}
	public Recruit_Infor(int recruit_no, String recruit_title,
			String[] hire_type, String recruit_number,
			String income_qualification, int max_pay, int min_pay,
			String[] career_check, int career_period, String ac_ability_no,
			String receive_sdate, String receive_ddate, String[] receive_way,
			String ads, String recruit_field, String[] recruit_position,
			String recruit_day, String[] recruit_addr, int etp_no) {
		super();
	...
	public String toString() {
		return "Recruit_Infor [recruit_no=" + recruit_no + ", recruit_title="
				+ recruit_title + ", hire_type=" + Arrays.toString(hire_type)
				+ ", recruit_number=" + recruit_number
				+ ", income_qualification=" + income_qualification
				+ ", max_pay=" + max_pay + ", min_pay=" + min_pay
				+ ", career_check=" + Arrays.toString(career_check)
				+ ", career_period=" + career_period + ", ac_ability_no="
				+ ac_ability_no + ", receive_sdate=" + receive_sdate
				+ ", receive_ddate=" + receive_ddate + ", receive_way="
				+ Arrays.toString(receive_way) + ", ads=" + ads
				+ ", recruit_field=" + recruit_field + ", recruit_position="
				+ Arrays.toString(recruit_position) + ", recruit_day="
				+ recruit_day + ", recruit_addr="
				+ Arrays.toString(recruit_addr) + ", etp_no=" + etp_no + "]";
	}
