...
public class ETP_Infor {
	...
	public ETP_Infor(int etp_no, String etp_name, String etp_id, String pass,
			...
			int etp_capital, int etp_sales, int clip_number) {
		this.etp_no = etp_no;
	...
	public String toString() {
		return "ETP_Info [etp_no=" + etp_no + ", etp_name=" + etp_name
				+ ", etp_id=" + etp_id + ", pass=" + pass + ", etp_tel="
				+ etp_tel + ", etp_email=" + etp_email + ", etp_kind="
				+ etp_kind + ", etp_registration_num=" + etp_registration_num
				+ ", delegator_name=" + delegator_name + ", etp_field="
				+ etp_field + ", employee_number=" + employee_number
				+ ", etp_location=" + Arrays.toString(etp_location)
